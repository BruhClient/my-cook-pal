...
const RecipeCard = ({recipe} : {recipe : Recipe}) => {
    ...
    return ( 
        <motion.div variants={AnimatePresenceVariants} initial="hidden" whileInView="visible" viewport={{once : true}}>
            <Card className="p-3 max-w-[400px] flex flex-col gap-2 shadow- w-full ">
